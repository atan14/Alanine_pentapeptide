...
def get_distance_between_data_cloud_center_and_potential_center(pdb_file):
    coor_file = {'Trp_cage': Trp_cage().generate_coordinates_from_pdb_files(pdb_file),
                 '2src': None,
                 '1y57': None,
                 'Alanine_pentapeptide': Alanine_pentapeptide().generate_coordinates_from_pdb_files(pdb_file)}[args.molecule]
    # if args.molecule == 'Trp_cage':
    #     coor_file = Trp_cage().generate_coordinates_from_pdb_files(pdb_file)[0]
    # elif args.molecule == 'Alanine_pentapeptide':
    #     coor_file = Alanine_pentapeptide().generate_coordinates_from_pdb_files(pdb_file)[0]
